...
import DashboardLogin, { initLogin } from './view/dashboard/login/dashboardLogin.jsx'
import Dashboard, { initDashboard } from './view/dashboard/dashboard/dashboard.jsx'
...
import CreateOffer from './view/dashboard/offers/components/createOffer.jsx'
  ...
  createRoutesFromElements(
    <Route>
      ...
      <Route path='dashboard'>
        <Route path='login' element={<DashboardLogin />} loader={initLogin} />
        <Route element={<Dashboard />} loader={initDashboard}>
